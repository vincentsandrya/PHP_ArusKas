...
<head>
  ...
  <title>Dashboard - Arus Kas</title>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      ...
      <a href="index.php" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Arus Kas</span>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">V. Sandrya</span>
...
$sqlQueryKebutuhan = mysqli_query($connection, 
  ...
  where c.KategoriName = 'Kebutuhan'
...
$sqlQueryKeinginan = mysqli_query($connection, 
  ...
  where c.KategoriName = 'Keinginan'
...
$rowKebutuhan = mysqli_fetch_array($sqlQueryKebutuhan);

$rowKeinginan = mysqli_fetch_array($sqlQueryKeinginan);
          ...
          <div class="col-12">
            ...
            <div class="card recent-sales overflow-auto">
              ...
              <center>
                ...
                <h5 class="card-title"><?php echo $StartDate?> - <?php echo date("Y/m/d")?></h5>
          ...
          <div class="col-xxl-4 col-md-6">
            ...
            <div class="card info-card revenue-card">
              ...
              <div class="card-body">
                ...
                <h5 class="card-title">Kebutuhan <span>| This Month</span></h5>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    ...
                    <span class="text-success small pt-1 fw-bold"><?php echo $rowKebutuhan["sisaPrcntg"] ?>%</span>
          ...
          <div class="col-xxl-4 col-md-6">
            ...
            <div class="card info-card revenue-card">
              ...
              <div class="card-body">
                ...
                <h5 class="card-title">Keinginan <span>| This Month</span></h5>
          ...
          <div class="col-12">
            ...
            <div class="card recent-sales overflow-auto">
              ...
              <div class="card-body">
                ...
                <h5 class="card-title">Recent Transaction <span>| This Month </span> </h5>
                ...
                <table class="table table-borderless datatable">
                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_array($sqlQueryRecentTrans))
